 ...
 * @author ravjotsingh
 */
public class TnCTextViewerController implements Initializable, IScreenController {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        String filePath = "bin/Support/TermsAndCondition.html";
        ...
        if (!CommonValidations.fileExists(filePath)) {
            ...
            request.setClientTnCFileChecksum("NA");
